...
/*111111111111111  S3移植至此  11111111111111111*/ 

std::string SystemInfo::GetMacAddressNoColon() {
    std::string mac_with_colon = GetMacAddress();  // 获取带冒号的MAC地址
    std::erase(mac_with_colon, ':');  // C++20 的 erase 直接删除字符
    return mac_with_colon;
}



// 将不带冒号的MAC地址转换为10进制，确保返回18位字符串
